# Kotlin TDD Development Plugin Instructions

## Scope

This generated adapter applies to the `kotlin-tdd-development` plugin payload. Do not edit it directly; update the provider-neutral primitives or plugin manifest, then regenerate the marketplace output.
...
Kotlin TDD, strict type and schema boundaries, Gradle green checks, and PR lifecycle workflows composed from independent primitives.
...
- `gradle-check-green`: `hooks/gradle-check-green.hooks.json` (source: `hooks/gradle-check-green.hook.json`)
