...
def main() -> int:
    ...
    parser.add_argument(
        "--primitive-audits",
        default="manifests/primitive-audits.json",
        help="Primitive audit ledger.",
    )
    parser.add_argument(
        "--promotions",
        default="manifests/promotions.json",
    ...
    parser.add_argument(
        "--doc",
        default="docs/review-completeness.md",
...
def notes(coverage_entry: dict[str, Any], audited: bool, promoted: bool) -> str:
    primitive = coverage_entry["primitive"]
    if audited:
        return "Primitive has a durable audit entry in manifests/primitive-audits.json."
