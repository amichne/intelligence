# Contract Governance Plugin Instructions

## Scope

This generated adapter applies to the `contract-governance` plugin payload. Do not edit it directly; update the provider-neutral primitives or plugin manifest, then regenerate the marketplace output.
...
Strict JSON Schema and OpenAPI contract work with typed boundary assertions, explicit variants, and contract review.
