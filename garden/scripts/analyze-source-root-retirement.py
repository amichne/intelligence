...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default="garden/manifests/source-root-retirement.json",
        help="Source-root retirement JSON to write.",
    )
    parser.add_argument(
        "--doc",
        default="garden/docs/source-root-retirement.md",
...
def evidence(
    ...
    return [
        f"garden/manifests/discovered-primitives.json records entries for sourceRoot {source_root}.",
        (
            "garden/manifests/source-review-decisions.json and garden/manifests/digest-review-decisions.json "
        ...
        (
            "garden/manifests/cleanup-ledger.json and garden/manifests/runtime-activation-approvals.json "
