...
|---|---|---|---|---|
| Codex | intelligence | https://github.com/amichne/intelligence/tree/marketplace | codex/marketplace.json | all configured plugins |

## Expected Plugins

| Plugin | Marketplace | Purpose | Status |
|---|---|---|---|
| intelligence-core | intelligence | Core repository onboarding, principles, and hooks | installed |
