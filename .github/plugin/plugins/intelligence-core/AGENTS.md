# Intelligence Core Plugin Instructions

## Scope

This generated adapter applies to the `intelligence-core` plugin payload. Do not edit it directly; update the provider-neutral primitives or plugin manifest, then regenerate the marketplace output.
...
Core repository onboarding, portable principles, and hooks from the intelligence source graph.
