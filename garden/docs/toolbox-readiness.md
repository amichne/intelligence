...
|---|---|---|---|
| `INCOMPLETE` | `canonical-primitive-set` | Canonical primitives: 50.<br>Audited canonical primitives: 49/50.<br>Needs audit: 1. | Keep adding primitive audits before treating any new canonical primitive as ready. |
| `INCOMPLETE` | `referential-plugins` | Referential plugins: 11.<br>All canonical primitives routed: false.<br>Coverage statuses: MARKETPLACE_EXPOSED=9, PLUGIN_COMPOSED=32, SCOPED_INSTRUCTION=6, STANDALONE_ONLY=3. | Route remaining standalone canonical primitives through plugins, marketplace entries, or scoped instructions. |
...
| `NEEDS_REVIEW` | `comprehensive-source-review` | Discovered primitive entries: 869.<br>Unreviewed singleton entries: 0.<br>Cleanup proposal gaps: 0.<br>Open source review groups: 0.<br>Open digest review groups: 0. | Resolve unreviewed entries, cleanup proposal gaps, or open review groups. |
