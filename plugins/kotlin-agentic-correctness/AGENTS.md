# Kotlin Agentic Correctness Plugin Instructions

## Scope

This generated adapter applies to the `kotlin-agentic-correctness` plugin payload. Do not edit it directly; update the provider-neutral primitives or plugin manifest, then regenerate the marketplace output.
...
Single Kotlin workflow combining typed design discipline, invariant-oriented Kotlin standards, filesystem-backed evidence, Kast semantic tooling, and Gradle/PR proof loops.
