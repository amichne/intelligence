...
| Measure | Value |
|---|---:|
| Source turnoff status | `REVIEW_READY` |
| Total packets | 18 |
| Ready for approval | 0 |
| Ready for manual import | 0 |
| Review required | 0 |
| Blocked | 0 |
| Already active | 18 |
...
Next action: No activation approval action is pending.

## Packets

| State | Risk | Type | Name | Source | Target |
|---|---|---|---|---|---|
| `ALREADY_ACTIVE` | `MEDIUM` | `ACTIVATE_RUNTIME_LINK` | `agent-skill-children` | `/Users/amichne/code/intelligence/skills` | `/Users/amichne/.agents/skills` |
...
| `ALREADY_ACTIVE` | `MEDIUM` | `ACTIVATE_RUNTIME_LINK` | `codex-skill-children` | `/Users/amichne/code/intelligence/skills` | `/Users/amichne/.codex/skills` |
| `ALREADY_ACTIVE` | `LOW` | `IMPORT_MARKETPLACE` | `codex-app-marketplace` | `/Users/amichne/code/intelligence/marketplace.json` | `codex://plugins?marketplacePath=/Users/amichne/code/intelligence/marketplace.json` |
...
- Marketplace source is already configured in Codex.
