# Openapi Authoring Best Practices Plugin Instructions

## Scope

This generated adapter applies to the `openapi-authoring-best-practices` plugin payload. Do not edit it directly; update the provider-neutral primitives or plugin manifest, then regenerate the marketplace output.
...
OpenAPI authoring, schema modeling, and contract rating workflows composed from independent primitives.
...
- `openapi-contract-rater`: `agents/openapi-contract-rater.agent.md` (source: `agents/openapi/openapi-contract-rater.agent.md`)
...
- `openapi-contract-authoring`: `skills/openapi-contract-authoring` (source: `skills/openapi-contract-authoring`)
- `openapi-contract-rating`: `skills/openapi-contract-rating` (source: `skills/openapi-contract-rating`)
- `openapi-schema-modeling`: `skills/openapi-schema-modeling` (source: `skills/openapi-schema-modeling`)
