...
- `.apm/instructions/type-safety.instructions.md`
- `.apm/instructions/schema-driven-design.instructions.md`
...
1. Read `.apm/instructions/type-safety.instructions.md` or the nearest repo-local equivalent before changing code or schema contracts.
2. Read `.apm/instructions/schema-driven-design.instructions.md` or the nearest repo-local equivalent before creating or changing boundary assertions, serialized data contracts, API payloads, messages, or persisted record shapes.
