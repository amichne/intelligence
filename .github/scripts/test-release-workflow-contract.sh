...
require_contains "$distribution_workflow" "marketplace author" "Distribution workflow must smoke the stable marketplace author surface"
require_contains "$distribution_workflow" "validate --repository" "Distribution workflow must smoke portable validation through the stable repository option"
...
require_contains "$release_workflow" "marketplace author" "Release workflow must smoke the stable marketplace author surface"
require_contains "$release_workflow" "validate --repository" "Release workflow must smoke portable validation through the stable repository option"
