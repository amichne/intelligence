...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default="manifests/runtime-activation-plan.json",
        help="Runtime activation plan JSON to write.",
    )
    parser.add_argument(
        "--doc",
        default="docs/runtime-activation-plan.md",
        ...
        operations.append(
            {
                ...
                "evidence": {
                    ...
                    "manifest": "manifests/cleanup-ledger.json",
                    "status": entry["status"],
        ...
        operations.append(
            {
                ...
                "evidence": {
                    "type": "RUNTIME_ACTIVATION_EVIDENCE",
                    "manifest": "manifests/runtime-links.json",
                    "status": entry["status"],
                },
