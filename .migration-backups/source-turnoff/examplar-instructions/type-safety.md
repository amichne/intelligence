...
contracts, and other boundary assertions, also apply
`instructions/schema-driven-design.md`. Types are the authority inside the program; schemas
are the authority at the boundary.
