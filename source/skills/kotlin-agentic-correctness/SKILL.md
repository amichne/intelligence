...
Use the bundled `kotlin-standards`, `kotlin-gradle-validation`, `tdd`,
`git-change-flow`, `github-ci-operations`, `pull-request-lifecycle`, and
`shell-script-safety` skills for their narrower procedures when the turn enters
their scope.
