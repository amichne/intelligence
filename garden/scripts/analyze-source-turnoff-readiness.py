...
def main() -> int:
    ...
    parser.add_argument(
        "--doc",
        default="garden/docs/source-turnoff-readiness.md",
    ...
    return [
        {
            ...
            "evidence": "garden/manifests/plugin-coverage.json reports all canonical primitives routed."
            if all_routed else
            "garden/manifests/plugin-coverage.json has STANDALONE_ONLY canonical primitives.",
